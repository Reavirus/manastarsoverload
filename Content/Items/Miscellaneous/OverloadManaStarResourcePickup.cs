...
namespace manaRecoveryMinigame.Content.Items.Miscellaneous
{
	...
	public class OverloadManaStarResourcePickup : ModItem
	{
		...
		{
			if (player.GetModPlayer<ManaMagnetChange>().overloadManaResourceMagnet)
			{
				grabRange += ManaMagnetChange.overloadManaResourceMagnetGrabRange;
			}
